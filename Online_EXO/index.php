        ...
        <div class="modal-dialog">
          <div class="modal-content title1">
            <div class="modal-header">
              ...
              <h4 class="modal-title title1"><span style="color:orange">Đăng Nhâp Dành Cho Sinh Viên</span></h4>
            </div>
              ...
              <form class="form-horizontal" action="login.php?q=index.php" method="POST">
                <fieldset>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-6">
                      <input id="email" name="email" placeholder="Nhập email-id" class="form-control input-md" type="email">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-6">
                      <input id="password" name="password" placeholder="Nhập Mặt Khẩu" class="form-control input-md" type="password">
  ...
  <div class="Background">
    ...
    <div class="row ParentForm">
      ...
      <div class="col-md-4 panel form">
        <!-- sign in form begins -->
        <h1 style=" font-family:'typo';">Đăng kí để tham gia cuộc thi!</h1>
        <form class="form-horizontal" name="form" action="sign.php?q=account.php" onSubmit="return validateForm()" method="POST">
          <fieldset>
            ...
            <div class="form-group">
              <label class="col-md-12 control-label" for="name"></label>
              <div class="col-md-12">
                <input id="college" name="college" placeholder="Nhập Trường Học" class="form-control input-md" type="text">
            ...
            <div class="form-group">
              ...
              <div class="col-md-12">
                <input id="cpassword" name="cpassword" placeholder="Nhập lại Mặt Khẩu" class="form-control input-md" type="password">
            ...
            <div class="form-group">
              ...
              <div class="col-md-12">
                <input type="submit" class="sub" value="Đăng Ký" class="btn btn-success" />
              </div>
            </div>
  ...
  <div class="modal fade" id="login">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
          <h4 class="modal-title"><span style="color:orange;font-family:'typo' ">Đăng Nhập Dành Cho Giảng Viên</span></h4>
        </div>
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <form role="form" method="post" action="admin.php?q=index.php">
                <div class="form-group">
                  <input type="text" name="uname" maxlength="20" placeholder="Nhập Email của Giảng Viên" class="form-control" />
                </div>
                <div class="form-group">
                  <input type="password" name="password" maxlength="15" placeholder="Nhập Mặt Khẩu của Giảng Viên" class="form-control" />
                </div>
