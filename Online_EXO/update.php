...
if (isset($_SESSION['key'])) {
  if (@$_GET['demail'] && $_SESSION['key'] == 'JNorm72') {
    $demail = @$_GET['demail'];
...
//xoa hoc phan thi
if (isset($_SESSION['key'])) {
  if (@$_GET['q'] == 'rmquiz' && $_SESSION['key'] == 'JNorm72') {
    $eid = @$_GET['eid'];
...
//them hoc phan thi
if (isset($_SESSION['key'])) {
  if (@$_GET['q'] == 'addquiz' && $_SESSION['key'] == 'JNorm72') {
    $name = $_POST['name'];
...
//add thong ti cau hoi
if (isset($_SESSION['key'])) {
  if (@$_GET['q'] == 'addqns' && $_SESSION['key'] == 'JNorm72') {
    $n = @$_GET['n'];
    $eid = @$_GET['eid'];
    $ch = @$_GET['ch'];
